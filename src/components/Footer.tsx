...
// Organization Schema for DamiTV - establishes authority as sports publisher
const organizationSchema = {
  "@context": "https://schema.org",
  "@type": "Organization",
  "name": "DamiTV",
  "alternateName": "Dami TV",
  "url": "https://damitv.pro",
  "logo": "https://damitv.pro/favicon.png",
  "description": "DamiTV is your premier destination for free live sports streaming. Watch football, basketball, tennis, and more in HD quality.",
  "foundingDate": "2024",
  "sameAs": [
    "https://facebook.com/damitv",
    "https://twitter.com/damitv",
    "https://instagram.com/damitv",
    "https://youtube.com/damitv"
  ],
  "contactPoint": {
    "@type": "ContactPoint",
    "contactType": "customer service",
    "url": "https://damitv.pro/contact",
  ...
  "publishingPrinciples": "https://damitv.pro/about"
};
...
const websiteSchema = {
  ...
  "potentialAction": {
    ...
    "target": {
      "@type": "EntryPoint",
      "urlTemplate": "https://damitv.pro/live?search={search_term_string}"
    },
...
const Footer = () => {
  ...
  return (
    <>
      {/* Organization & WebSite Schema - placed in footer for site-wide inclusion */}
      <Helmet>
